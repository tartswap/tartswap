...
/**
 * @title TartLPFarmV3
 * @notice Multi-pool LP farming contract with Safe-owned admin and limited operators.
 * @dev Operators can manage LP pool creation/settings; owner-only powers remain with Safe.
 */
contract TartLPFarmV3 is Ownable, Pausable, ReentrancyGuard {
    ...
    mapping(address => bool) public stakeTokenConfigured;
    ...
    function addPool(
        ...
        require(!stakeTokenConfigured[stakeToken], "Stake token exists");
        ...
        stakeTokenConfigured[stakeToken] = true;
